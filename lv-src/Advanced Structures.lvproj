...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Tests" Type="Folder">
			<Item Name="Test ALL.vi" Type="VI" URL="../_tests/Test ALL.vi"/>
			...
			<Item Name="Test Stack Preview Elements.vi" Type="VI" URL="../_tests/Test Stack Preview Elements.vi"/>
		</Item>
		<Item Name="CircularBuffer.lvlib" Type="Library" URL="../Circular Buffers/CircularBuffer.lvlib"/>
		<Item Name="Example -- Producer-Consumer as a Stack (FILO).vi" Type="VI" URL="../Circular Buffers/Example -- Producer-Consumer as a Stack (FILO).vi"/>
		<Item Name="Example -- Producer-Monitor as a Queue (FIFO).vi" Type="VI" URL="../Circular Buffers/Example -- Producer-Monitor as a Queue (FIFO).vi"/>
		<Item Name="Example -- Circular Buffer Map.vi" Type="VI" URL="../Circular Buffers/Example -- Circular Buffer Map.vi"/>
